/**
 * Force HTTP/1.1 for all outbound server fetches. Node runtime only — the
 * runtime guard lives in instrumentation.ts, and this file must stay a
 * separate module so the Edge bundle never sees the undici import (Vercel
 * rejects Edge functions that reference it).
 *
